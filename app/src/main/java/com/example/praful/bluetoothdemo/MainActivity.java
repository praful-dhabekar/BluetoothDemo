...
public class MainActivity extends ActionBarActivity {
    ...
    TextView textInfo, textStatus, textViewBytes;
    ListView listViewPairedDevice;
    LinearLayout inputPane;
    EditText inputField;
    Button btnSend;
    String tempValue,ldrValue,gasValue;

    TextView temp, gas, ldr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gas = (TextView) findViewById(R.id.tv_gas_sensor);
        ldr = (TextView) findViewById(R.id.tv_ldr);

        textViewBytes = (TextView)findViewById(R.id.tv_bytes);
...
//                        inputPane.setVisibility(View.VISIBLE);
    ...
    protected class AsyncInsertValues extends
            AsyncTask<ValueDetails, Void, Void> {
        @Override
        protected Void doInBackground(ValueDetails... params) {
            RestAPI api = new RestAPI();
            try{
                api.InsertNewValues(params[0].getTemp(),params[0].getLdr(),
                        params[0].getGas(), params[0].getDateTime());
            }
            catch (Exception e) {
                e.printStackTrace();
                Log.d("AsyncInsertValues", e.getMessage());
            }
            return null;
        }
    }
